...
For more information on arrays, objects, functions, and classes in JavaScript, checkout the [documentation](https://developer.mozilla.org/en-US/docs/Web/JavaScript) maintained by MDN Web Docs.
